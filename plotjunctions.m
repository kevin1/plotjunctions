...
E_val_style = '-b';		% solid blue
E_cnd_style = '-g';		% solid green
E_fermi_style = '--r';	% dashed red
...
plot(...
	xrange(:, 1), [E_val_plot(1, 1),   E_val_plot(1, 1)], E_val_style,    ...
...
plot(...
	xrange(:, 2), [E_val_plot(1, 2),   E_val_plot(1, 2)], E_val_style, ...
	xrange(:, 2), [E_cnd_plot(1, 2),   E_cnd_plot(1, 2)], E_cnd_style, ...
